...
const translations = {
  ar: {
    ...
    // Search
    search_placeholder: "ابحث عن وظائف، أشخاص، أو سلع...",
    search_recent: "عمليات البحث الأخيرة",
    search_suggested: "مقترحات لك",
    search_results: "نتائج البحث",
    search_no_results: "لا توجد نتائج مطابقة",
    search_tab_all: "الكل",
    search_tab_jobs: "وظائف",
    search_tab_people: "أشخاص",
    search_tab_haraj: "حراج",
    search_clear: "مسح",
    ...
    // Urgent Jobs View
    urgent_jobs_title: "وظائف",
    urgent_badge: "عاجل",
    urgent_jobs_subtitle: "فرص عمل فورية ومؤقتة",
    urgent_now: "مطلوب الآن",
    temp_contracts: "عقود مؤقتة",
    daily_payment: "دفع يومي",
    urgent_label: "عاجل",
    urgent_job_title: "فرصة عمل فورية",
    no_urgent_jobs: "لا توجد وظائف مستعجلة حالياً",
    check_back_later: "تضاف وظائف جديدة كل ساعة، عد لاحقاً",
    
    // Create Post - Urgent Options
    scope_urgent_page: "الصفحة المستعجلة",
    scope_urgent_desc: "للفرص الفورية فقط",
    select_urgent_type: "اختر نوع الاستعجال",
    urgent_opt_now: "مطلوب الآن",
    urgent_opt_temp: "عقود مؤقتة",
    urgent_opt_daily: "دفع يومي",
    urgent_employer_switch_title: "تغيير نوع الإعلان",
    urgent_employer_switch_msg: "ميزة النشر في هذه الصفحة مخصصة فقط لمن يبحث عن موظفين مؤقتين.\n\nيمكنك نشر منشوراتك للبحث عن وظيفة في قسم الرئيسية أو القسم المخصص حسب التصنيف المختار.\n\nشكراً لتفهمك.",
    ...
    world_jobs_title: "وظائف عالمية",
    world_jobs_subtitle: "فرص عمل في كبرى الشركات العالمية",
    ...
    // CV / Professional Card (UPDATED)
    cv_welcome_title: "بطاقة الهوية المهنية",
    cv_form_title: "بيانات البطاقة",
    cv_label_photo: "صورة شخصية",
    cv_label_fullname: "الاسم الكامل",
    cv_label_dob: "تاريخ الميلاد",
    cv_label_jobtitle: "المسمى الوظيفي",
    cv_label_languages: "اللغات",
    cv_label_companies: "الخبرات السابقة",
    cv_label_bio: "نبذة عني (حد أقصى 50 حرف)",
    cv_label_country: "الدولة",
    cv_label_city: "المدينة",
    cv_label_education: "المؤهل / الدراسة",
    cv_ph_education: "مثال: بكالوريوس هندسة",
    cv_ph_languages: "مثال: العربية، الإنجليزية",
    cv_ph_companies: "مثال: أرامكو، سابك...",
    cv_ph_country: "مثال: السعودية",
    cv_ph_city: "مثال: الرياض",
    cv_btn_back: "رجوع",
    cv_day: "اليوم",
    cv_month: "الشهر",
    cv_year: "السنة",
    ...
    // Privacy - Updated Content with Compliance Details
    privacy_title: "سياسة الخصوصية وشروط الاستخدام",
    privacy_desc: "نحن في تطبيق 'مهنتي لي' نلتزم بأعلى معايير الشفافية وحماية البيانات. يرجى قراءة السياسة التالية بعناية:\n\n1. جمع واستخدام البيانات\nنقوم بجمع البيانات التي تقدمها طواعية (الاسم، البريد الإلكتروني، المحتوى النصي) فقط لغرض تحسين تجربتك وإنشاء ملفك المهني.\n\n2. الميزات المعطلة (تحت الصيانة)\n- الفيديوهات: ميزة رفع وتشغيل الفيديوهات معطلة حالياً لأغراض التطوير والصيانة.\n- البطاقة المهنية: خدمة البطاقة المهنية متاحة للعرض الداخلي فقط؛ ميزة الاستخراج والطباعة معطلة حالياً.\n\n3. دور الذكاء الاصطناعي\nالذكاء الاصطناعي في التطبيق هو مساعد تعليمي وتوجيهي فقط. وظائفه محددة في:\n- تقديم نصائح لكتابة سيرة ذاتية.\n- شرح كيفية استخدام التطبيق.\nتنبيه: الذكاء الاصطناعي لا ينشئ إعلانات، لا ينشر محتوى نيابة عنك، ولا يقوم بتتبع سلوك المستخدم لأغراض تجارية.\n\n4. التواصل والروابط الخارجية (إخلاء مسؤولية هام)\n- لا يوجد شات داخلي: التطبيق لا يحتوي على نظام محادثة داخلي. جميع عمليات التواصل تتم خارج التطبيق عبر وسائل الطرف الثالث (واتساب، اتصال هاتفي، بريد إلكتروني).\n- الروابط الخارجية: التطبيق قد يحتوي على روابط لمواقع خارجية. نحن لسنا مسؤولين عن محتوى أو سياسات الخصوصية لتلك المواقع.\n\n5. تحذيرات الاحتيال والنصب\n- التطبيق غير مسؤول عن أي تعاملات مالية تتم خارج المنصة.\n- تحذير: لا تقم أبداً بدفع مبالغ مالية مقابل التوظيف أو المقابلات.\n- احذر من الروابط المشبوهة التي قد تصلك عبر وسائل التواصل الخارجية.\n\n6. مشاركة البيانات مع الجهات الحكومية\nنحن نحفظ بياناتك بأمان ولا نبيعها. ومع ذلك، قد نقوم بمشاركة بياناتك الشخصية مع الجهات الحكومية أو السلطات الرسمية إذا كان ذلك مطلوباً بموجب القانون، أو استجابةً لإجراءات قانونية، أو لحماية حقوق وسلامة المستخدمين والجمهور.\n\n7. التواصل\nللاستفسارات القانونية والتقنية:\nالمطور: صلاح الدين مهدلي\nالبريد الإلكتروني: salahmhdly2@gmail.com",
    ...
    // AI Chat (New)
    ai_title: "مساعد مهنتي",
    ai_thinking: "مهنتي لي يفكر الآن...",
    ai_online: "مهنتي لي متصل الآن",
    ai_welcome_msg: "مرحباً بك في ذكاء اصطناعي مهنتي لي.. هل تبحث عن وظيفه ام موظفين؟",
    ai_placeholder: "اكتب رسالتك هنا...",
    ai_error: "عذراً، حدث خطأ في الاتصال. يرجى المحاولة مرة أخرى لاحقاً.",
    ai_powered: "مدعوم بواسطة Google Gemini",
  ...
  en: {
    ...
    // Search
    search_placeholder: "Search for jobs, people, or items...",
    search_recent: "Recent Searches",
    search_suggested: "Suggested for you",
    search_results: "Search Results",
    search_no_results: "No results found",
    search_tab_all: "All",
    search_tab_jobs: "Jobs",
    search_tab_people: "People",
    search_tab_haraj: "Marketplace",
    search_clear: "Clear",
    ...
    // Urgent Jobs View
    urgent_jobs_title: "Jobs",
    urgent_badge: "Urgent",
    urgent_jobs_subtitle: "Immediate & Temporary Opportunities",
    urgent_now: "Needed Now",
    temp_contracts: "Temp Contracts",
    daily_payment: "Daily Pay",
    urgent_label: "Urgent",
    urgent_job_title: "Immediate Opportunity",
    no_urgent_jobs: "No urgent jobs right now",
    check_back_later: "New jobs added hourly, check back later",
    
    // Create Post - Urgent Options
    scope_urgent_page: "Urgent Page",
    scope_urgent_desc: "For immediate opportunities only",
    select_urgent_type: "Select Urgency Type",
    urgent_opt_now: "Needed Now",
    urgent_opt_temp: "Temp Contracts",
    urgent_opt_daily: "Daily Payment",
    urgent_employer_switch_title: "Ad Type Changed",
    urgent_employer_switch_msg: "Publishing on the Urgent Page is reserved for employers looking for immediate staff.\n\nYour ad type has been automatically switched to 'Hiring'.\n\nIf you are looking for a job, please publish in 'Home' or 'Category' sections.\n\nThank you for understanding.",
    ...
    world_jobs_title: "Global Jobs",
    world_jobs_subtitle: "Opportunities from top global companies",
    ...
    // CV / Professional Card (UPDATED)
    cv_welcome_title: "Professional Identity Card",
    cv_form_title: "Card Details",
    cv_label_photo: "Profile Photo",
    cv_label_fullname: "Full Name",
    cv_label_dob: "Date of Birth",
    cv_label_jobtitle: "Job Title",
    cv_label_languages: "Languages",
    cv_label_companies: "Experience",
    cv_label_bio: "Bio (Max 50 chars)",
    cv_label_country: "Country",
    cv_label_city: "City",
    cv_label_education: "Education / Degree",
    cv_ph_education: "Ex: Bachelor of Engineering",
    cv_ph_languages: "Ex: Arabic, English",
    cv_ph_companies: "Ex: Aramco, SABIC...",
    cv_ph_country: "Ex: Saudi Arabia",
    cv_ph_city: "Ex: Riyadh",
    cv_btn_back: "Back",
    cv_day: "Day",
    cv_month: "Month",
    cv_year: "Year",
    ...
    privacy_desc: "At 'Mehnati Li', we are committed to the highest standards of data protection. Please read the following carefully:\n\n1. Data Collection & Use\nWe collect data you voluntarily provide (name, email, text content) solely to improve your experience and build your professional profile.\n\n2. Disabled Features (Under Maintenance)\n- Videos: Video uploading is currently disabled for maintenance.\n- Professional Card: Currently for internal viewing only; printing/exporting is disabled.\n\n3. AI Assistant Role\nThe AI is strictly an educational assistant. Its functions are limited to:\n- Providing CV writing tips.\n- Explaining app usage.\nNote: The AI does NOT create ads, does NOT post on your behalf, and does NOT track user behavior for commercial purposes.\n\n4. External Communication & Links (Disclaimer)\n- No Internal Chat: All communication happens OUTSIDE the app (WhatsApp, Phone, Email). We are not responsible for external interactions.\n- External Links: The app may contain links to third-party sites. We are not responsible for their content or privacy practices.\n\n5. Fraud Warning\n- Never pay money for job applications.\n- Be cautious of suspicious links sent via external communication channels.\n\n6. Government Data Sharing\nWe do not sell your data. However, we may disclose your personal information to government authorities or law enforcement agencies if required by law, court order, or to protect public safety.\n\n7. Contact\nDeveloper: Salah Al-Din Mahdali\nEmail: salahmhdly2@gmail.com",
    ...
    // AI Chat (New)
    ai_title: "Mehnati Assistant",
    ai_thinking: "Mehnati Li is thinking...",
    ai_online: "Mehnati Li is Online",
    ai_welcome_msg: "Welcome to Mehnati AI... Are you looking for a job or employees?",
    ai_placeholder: "Type your message here...",
    ai_error: "Sorry, connection error. Please try again later.",
    ai_powered: "Powered by Google Gemini",
